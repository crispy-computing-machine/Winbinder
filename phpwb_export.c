...
ZEND_MINIT_FUNCTION(winbinder)
{
	...
	// Window classes
	WB_ZEND_CONST(LONGLONG, "AppWindow", AppWindow)
	WB_ZEND_CONST(LONGLONG, "ModalDialog", ModalDialog)
	WB_ZEND_CONST(LONGLONG, "ModelessDialog", ModelessDialog)
	WB_ZEND_CONST(LONGLONG, "NakedWindow", NakedWindow)
	WB_ZEND_CONST(LONGLONG, "PopupWindow", PopupWindow)
	WB_ZEND_CONST(LONGLONG, "ResizableWindow", ResizableWindow)
	WB_ZEND_CONST(LONGLONG, "ToolDialog", ToolDialog)

	// WinBinder control classes

	WB_ZEND_CONST(LONGLONG, "Accel", Accel)
	WB_ZEND_CONST(LONGLONG, "Calendar", Calendar)
	WB_ZEND_CONST(LONGLONG, "CheckBox", CheckBox)
	WB_ZEND_CONST(LONGLONG, "ComboBox", ComboBox)
	WB_ZEND_CONST(LONGLONG, "EditBox", EditBox)
	WB_ZEND_CONST(LONGLONG, "Frame", Frame)
	WB_ZEND_CONST(LONGLONG, "Gauge", Gauge)
	WB_ZEND_CONST(LONGLONG, "HTMLControl", HTMLControl)
	WB_ZEND_CONST(LONGLONG, "HyperLink", HyperLink)
	WB_ZEND_CONST(LONGLONG, "ImageButton", ImageButton)
	WB_ZEND_CONST(LONGLONG, "InvisibleArea", InvisibleArea)
	WB_ZEND_CONST(LONGLONG, "Label", Label)
	WB_ZEND_CONST(LONGLONG, "ListBox", ListBox)
	WB_ZEND_CONST(LONGLONG, "ListView", ListView)
	WB_ZEND_CONST(LONGLONG, "Menu", Menu)
	WB_ZEND_CONST(LONGLONG, "PushButton", PushButton)
	WB_ZEND_CONST(LONGLONG, "RTFEditBox", RTFEditBox)
	WB_ZEND_CONST(LONGLONG, "RadioButton", RadioButton)
	WB_ZEND_CONST(LONGLONG, "ScrollBar", ScrollBar)
	WB_ZEND_CONST(LONGLONG, "Slider", Slider)
	WB_ZEND_CONST(LONGLONG, "Spinner", Spinner)
	WB_ZEND_CONST(LONGLONG, "StatusBar", StatusBar)
	WB_ZEND_CONST(LONGLONG, "TabControl", TabControl)
	WB_ZEND_CONST(LONGLONG, "ToolBar", ToolBar)
	WB_ZEND_CONST(LONGLONG, "TreeView", TreeView)
	...
	WB_ZEND_CONST(LONGLONG, "WBC_BORDER", WBC_BORDER)
	WB_ZEND_CONST(LONGLONG, "WBC_BOTTOM", WBC_BOTTOM)
	WB_ZEND_CONST(LONGLONG, "WBC_CENTER", WBC_CENTER)
	WB_ZEND_CONST(LONGLONG, "WBC_CHECKBOXES", WBC_CHECKBOXES)
	WB_ZEND_CONST(LONGLONG, "WBC_CUSTOMDRAW", WBC_CUSTOMDRAW)
	WB_ZEND_CONST(LONGLONG, "WBC_DEFAULTPOS", WBC_DEFAULTPOS)
	WB_ZEND_CONST(LONGLONG, "WBC_DISABLED", WBC_DISABLED)
	WB_ZEND_CONST(LONGLONG, "WBC_ELLIPSIS", WBC_ELLIPSIS)
	WB_ZEND_CONST(LONGLONG, "WBC_ENABLED", WBC_ENABLED)
	WB_ZEND_CONST(LONGLONG, "WBC_GROUP", WBC_GROUP)
	WB_ZEND_CONST(LONGLONG, "WBC_IMAGE", WBC_IMAGE)
	WB_ZEND_CONST(LONGLONG, "WBC_INVISIBLE", WBC_INVISIBLE)
	WB_ZEND_CONST(LONGLONG, "WBC_LEFT", WBC_LEFT)
	WB_ZEND_CONST(LONGLONG, "WBC_LINES", WBC_LINES)
	WB_ZEND_CONST(LONGLONG, "WBC_MASKED", WBC_MASKED)
	WB_ZEND_CONST(LONGLONG, "WBC_MIDDLE", WBC_MIDDLE)
	WB_ZEND_CONST(LONGLONG, "WBC_MULTILINE", WBC_MULTILINE)
	WB_ZEND_CONST(LONGLONG, "WBC_NOTIFY", WBC_NOTIFY)
	WB_ZEND_CONST(LONGLONG, "WBC_NUMBER", WBC_NUMBER)
	WB_ZEND_CONST(LONGLONG, "WBC_READONLY", WBC_READONLY)
	WB_ZEND_CONST(LONGLONG, "WBC_RIGHT", WBC_RIGHT)
	WB_ZEND_CONST(LONGLONG, "WBC_SINGLE", WBC_SINGLE)
	WB_ZEND_CONST(LONGLONG, "WBC_SORT", WBC_SORT)
	WB_ZEND_CONST(LONGLONG, "WBC_TASKBAR", WBC_TASKBAR)
	WB_ZEND_CONST(LONGLONG, "WBC_AUTOREPEAT", WBC_AUTOREPEAT)
	WB_ZEND_CONST(LONGLONG, "WBC_TOP", WBC_TOP)
	WB_ZEND_CONST(LONGLONG, "WBC_VISIBLE", WBC_VISIBLE)
	WB_ZEND_CONST(LONGLONG, "WBC_TRANSPARENT", WBC_TRANSPARENT)
	WB_ZEND_CONST(LONGLONG, "WBC_DEFAULT", WBC_DEFAULT)
	WB_ZEND_CONST(LONGLONG, "WBC_MULTISELECT", WBC_MULTISELECT)
	WB_ZEND_CONST(LONGLONG, "WBC_NOHEADER", WBC_NOHEADER)

	// Notification message flags

	WB_ZEND_CONST(LONGLONG, "WBC_DBLCLICK", WBC_DBLCLICK)
	WB_ZEND_CONST(LONGLONG, "WBC_MOUSEMOVE", WBC_MOUSEMOVE)
	WB_ZEND_CONST(LONGLONG, "WBC_MOUSEDOWN", WBC_MOUSEDOWN)
	WB_ZEND_CONST(LONGLONG, "WBC_MOUSEUP", WBC_MOUSEUP)
	WB_ZEND_CONST(LONGLONG, "WBC_KEYDOWN", WBC_KEYDOWN)
	WB_ZEND_CONST(LONGLONG, "WBC_KEYUP", WBC_KEYUP)
	WB_ZEND_CONST(LONGLONG, "WBC_GETFOCUS", WBC_GETFOCUS)
	WB_ZEND_CONST(LONGLONG, "WBC_RESIZE", WBC_RESIZE)
	WB_ZEND_CONST(LONGLONG, "WBC_REDRAW", WBC_REDRAW)
	WB_ZEND_CONST(LONGLONG, "WBC_HEADERSEL", WBC_HEADERSEL)


	// Additional notification message flags

	WB_ZEND_CONST(LONGLONG, "WBC_ALT", WBC_ALT)
	WB_ZEND_CONST(LONGLONG, "WBC_CONTROL", WBC_CONTROL)
	WB_ZEND_CONST(LONGLONG, "WBC_SHIFT", WBC_SHIFT)
	WB_ZEND_CONST(LONGLONG, "WBC_LBUTTON", WBC_LBUTTON)
	WB_ZEND_CONST(LONGLONG, "WBC_MBUTTON", WBC_MBUTTON)
	WB_ZEND_CONST(LONGLONG, "WBC_RBUTTON", WBC_RBUTTON)

	// Message box and beep types

	WB_ZEND_CONST(LONGLONG, "WBC_BEEP", WBC_BEEP)
	WB_ZEND_CONST(LONGLONG, "WBC_INFO", MB_ICONINFORMATION)
	WB_ZEND_CONST(LONGLONG, "WBC_OK", MB_OK)
	WB_ZEND_CONST(LONGLONG, "WBC_OKCANCEL", MB_OKCANCEL | MB_ICONQUESTION)
	WB_ZEND_CONST(LONGLONG, "WBC_QUESTION", MB_ICONQUESTION)
	WB_ZEND_CONST(LONGLONG, "WBC_STOP", MB_ICONSTOP)
	WB_ZEND_CONST(LONGLONG, "WBC_WARNING", MB_ICONWARNING)
	WB_ZEND_CONST(LONGLONG, "WBC_YESNO", MB_YESNO | MB_ICONQUESTION)
	WB_ZEND_CONST(LONGLONG, "WBC_YESNOCANCEL", MB_YESNOCANCEL | MB_ICONQUESTION)

	// Window states

	WB_ZEND_CONST(LONGLONG, "WBC_MAXIMIZED", WBC_MAXIMIZED)
	WB_ZEND_CONST(LONGLONG, "WBC_MINIMIZED", WBC_MINIMIZED)
	WB_ZEND_CONST(LONGLONG, "WBC_NORMAL", WBC_NORMAL)

	// Area types for wb_set_area()

	WB_ZEND_CONST(LONGLONG, "WBC_MINSIZE", WBC_MINSIZE);
	WB_ZEND_CONST(LONGLONG, "WBC_MAXSIZE", WBC_MAXSIZE);
	WB_ZEND_CONST(LONGLONG, "WBC_TITLE", WBC_TITLE);

	// Windows standard identifiers

	WB_ZEND_CONST(LONGLONG, "IDABORT", IDABORT);
	WB_ZEND_CONST(LONGLONG, "IDCANCEL", IDCANCEL);
	WB_ZEND_CONST(LONGLONG, "IDCLOSE", IDCLOSE);
	WB_ZEND_CONST(LONGLONG, "IDDEFAULT", IDDEFAULT);
	WB_ZEND_CONST(LONGLONG, "IDHELP", IDHELP);
	WB_ZEND_CONST(LONGLONG, "IDIGNORE", IDIGNORE);
	WB_ZEND_CONST(LONGLONG, "IDNO", IDNO);
	WB_ZEND_CONST(LONGLONG, "IDOK", IDOK);
	WB_ZEND_CONST(LONGLONG, "IDRETRY", IDRETRY);
	WB_ZEND_CONST(LONGLONG, "IDYES", IDYES);

	// Font attributes

	WB_ZEND_CONST(LONGLONG, "FTA_BOLD", FTA_BOLD);
	WB_ZEND_CONST(LONGLONG, "FTA_ITALIC", FTA_ITALIC);
	WB_ZEND_CONST(LONGLONG, "FTA_NORMAL", FTA_NORMAL);
	WB_ZEND_CONST(LONGLONG, "FTA_REGULAR", FTA_NORMAL);
	WB_ZEND_CONST(LONGLONG, "FTA_STRIKEOUT", FTA_STRIKEOUT);
	WB_ZEND_CONST(LONGLONG, "FTA_UNDERLINE", FTA_UNDERLINE);

	// RGB standard colors

	WB_ZEND_CONST(LONGLONG, "BLACK", RGB(0, 0, 0))
	WB_ZEND_CONST(LONGLONG, "BLUE", RGB(0, 0, 255))
	WB_ZEND_CONST(LONGLONG, "CYAN", RGB(0, 255, 255))
	WB_ZEND_CONST(LONGLONG, "DARKBLUE", RGB(0, 0, 128))
	WB_ZEND_CONST(LONGLONG, "DARKCYAN", RGB(0, 128, 128))
	WB_ZEND_CONST(LONGLONG, "DARKGRAY", RGB(128, 128, 128))
	WB_ZEND_CONST(LONGLONG, "DARKGREEN", RGB(0, 128, 0))
	WB_ZEND_CONST(LONGLONG, "DARKMAGENTA", RGB(128, 0, 128))
	WB_ZEND_CONST(LONGLONG, "DARKRED", RGB(128, 0, 0))
	WB_ZEND_CONST(LONGLONG, "DARKYELLOW", RGB(128, 128, 0))
	WB_ZEND_CONST(LONGLONG, "GREEN", RGB(0, 255, 0))
	WB_ZEND_CONST(LONGLONG, "LIGHTGRAY", RGB(192, 192, 192))
	WB_ZEND_CONST(LONGLONG, "MAGENTA", RGB(255, 0, 255))
	WB_ZEND_CONST(LONGLONG, "RED", RGB(255, 0, 0))
	WB_ZEND_CONST(LONGLONG, "WHITE", RGB(255, 255, 255))
	WB_ZEND_CONST(LONGLONG, "YELLOW", RGB(255, 255, 0))
	WB_ZEND_CONST(LONGLONG, "NOCOLOR", NOCOLOR)
	WB_ZEND_CONST(LONGLONG, "WINCOLOUR", WINCOLOUR)

	// BGR standard colors

	WB_ZEND_CONST(LONGLONG, "bgrBLACK", RGB(0, 0, 0))
	WB_ZEND_CONST(LONGLONG, "bgrBLUE", RGB(255, 0, 0))
	WB_ZEND_CONST(LONGLONG, "bgrCYAN", RGB(255, 255, 0))
	WB_ZEND_CONST(LONGLONG, "bgrDARKBLUE", RGB(128, 0, 0))
	WB_ZEND_CONST(LONGLONG, "bgrDARKCYAN", RGB(128, 128, 0))
	WB_ZEND_CONST(LONGLONG, "bgrDARKGRAY", RGB(128, 128, 128))
	WB_ZEND_CONST(LONGLONG, "bgrDARKGREEN", RGB(0, 128, 0))
	WB_ZEND_CONST(LONGLONG, "bgrDARKMAGENTA", RGB(128, 0, 128))
	WB_ZEND_CONST(LONGLONG, "bgrDARKRED", RGB(0, 0, 128))
	WB_ZEND_CONST(LONGLONG, "bgrDARKYELLOW", RGB(0, 128, 128))
	WB_ZEND_CONST(LONGLONG, "bgrGREEN", RGB(0, 255, 0))
	WB_ZEND_CONST(LONGLONG, "bgrLIGHTGRAY", RGB(192, 192, 192))
	WB_ZEND_CONST(LONGLONG, "bgrMAGENTA", RGB(255, 0, 255))
	WB_ZEND_CONST(LONGLONG, "bgrRED", RGB(0, 0, 255))
	WB_ZEND_CONST(LONGLONG, "bgrWHITE", RGB(255, 255, 255))
	WB_ZEND_CONST(LONGLONG, "bgrYELLOW", RGB(0, 255, 255))
	WB_ZEND_CONST(LONGLONG, "bgrNOCOLOR", NOCOLOR)
	WB_ZEND_CONST(LONGLONG, "bgrWINCOLOUR", WINCOLOUR)

	// Listview custom color state
	WB_ZEND_CONST(LONGLONG, "WBC_LV_NONE", WBC_LV_NONE);
	WB_ZEND_CONST(LONGLONG, "WBC_LV_FORE", WBC_LV_FORE);
	WB_ZEND_CONST(LONGLONG, "WBC_LV_BACK", WBC_LV_BACK);
	WB_ZEND_CONST(LONGLONG, "WBC_LV_DEFAULT", WBC_LV_DEFAULT);
	WB_ZEND_CONST(LONGLONG, "WBC_LV_DRAW", WBC_LV_DRAW);
	WB_ZEND_CONST(LONGLONG, "WBC_LV_COLUMNS", WBC_LV_COLUMNS);

	// RTFEditBox
	WB_ZEND_CONST(LONGLONG, "WBC_RTF_TEXT", WBC_RTF_TEXT);
	return SUCCESS;
}
